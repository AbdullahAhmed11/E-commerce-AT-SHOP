...
let product__list = document.querySelector("#products");
...
renderProducts = (products) => {
    products.forEach(e => {
        ...
        `
        product__list.insertAdjacentHTML("beforeend", prod)
    })
}

renderProducts(products);

let filter__col= document.querySelector("#filter-col");

document.querySelector("#filter-toggle").addEventListener("click", () => filter__col.classList.toggle('active'))
document.querySelector('#filter-close').addEventListener('click', () => filter__col.classList.toggle('active'))